      ...
      <div className="history-bg-container">
        <div className="history-nav-container">
          <img
            ...
            alt="app logo"
            className="history-nav-logo"
          />
          <div className="history-nav-search-el">
            <img
              src="https://assets.ccbp.in/frontend/react-js/search-img.png"
              alt="search"
              className="history-nav-search"
            />
            <input
              type="search"
              className="history-nav-search-input"
        ...
        {filteredHistoryList.length === 0 ? (
          <div className="history-empty-list-msg">
